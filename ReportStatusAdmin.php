...
<head>
    ...
    <!-- Page title -->
    <title><?= $fgmembersite->Title1 ?> | Admin Status Report </title>
            ...
            <div class="hpanel">
                ...
                <div class="panel-body">
                    <table id="optdetails" class="table table-striped table-bordered table-hover" width="100%">
													...
													<tbody>
														<?php
															echo $Reports->StatusReportAdmin($fgmembersite); 
														?>
													</tbody>
												</table>
                </div>
    ...
    $(function () {
        $('#optdetails').dataTable( {
            ...
            buttons: [
                ...
                {extend: 'csv',title: 'Admin Status Report', className: 'btn-sm'},
                {extend: 'pdf', title: 'Admin Status Report', className: 'btn-sm'},
