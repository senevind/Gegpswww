...
function load(reson){
		...
		xmlhttp.onreadystatechange=function()
		  ...
		  if (xmlhttp.readyState==4 && xmlhttp.status==200)
				...
				if(reson=='ThisMontInstallation'){
					ThisMontInstallation(xmlhttp.responseText);
				}
				if(reson=='ThisMonthRenewal'){
					ThisMonthRenewal(xmlhttp.responseText);
				}
				}
		  }
	xmlhttp.open("GET","getcoordinates.php?resonAdmin="+reson);
	xmlhttp.send();
}
...
function dashboard_refresh()
{
	...
	load('runnivcount');
	//load('alltodaymilage');
	load('ThisMontInstallation');
	load('ThisMonthRenewal');
}

function fleetstatusupdate()
{
$.get( "getcoordinates.php?resonAdmin=fleetstatus", function( data ) {
...
<div id="wrapper">
    ...
    <div class="content">
		<div class="row" >
            <div class="col-lg-3">
				<script>
				function ThisMonthRenewal(result){
									document.getElementById("ThisMonthRenewal").innerHTML = result;
				}
				</script>
				<div class="hpanel">
					<div class="panel-body">
						<div class="flot-pie-chart" >
							<div class="panel-body text-center h-200">
								...
								<h1 class="m-xs"  id = "ThisMonthRenewal">0</h1>
            ...
            <div class="col-lg-3">
				<script>
				function ThisMontInstallation(result){
									document.getElementById("ThisMontInstallation").innerHTML = result;
				}
				</script>
				<div class="hpanel">
					<div class="panel-body">
						<div class="flot-pie-chart" >
							<div class="panel-body text-center h-200">
								...
								<h1 class="m-xs"  id = "ThisMontInstallation">0</h1>
