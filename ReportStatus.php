...
<head>
    ...
    <!-- Page title -->
    <title><?= $fgmembersite->Title1 ?> | Status Report </title>
                ...
                <div class="panel-body">
                    <table id="optdetails" class="table table-striped table-bordered table-hover" width="100%">
													...
													<tr>
														...
														<th data-hide="phone,tablet">Engine</th>
													...
													<tbody>
														<?php
															echo $Reports->StatusReport($fgmembersite); 
														?>
													</tbody>
												</table>
                </div>
    ...
    $(function () {
        $('#optdetails').dataTable( {
            ...
            buttons: [
                ...
                {extend: 'csv',title: 'Status Report', className: 'btn-sm'},
                {extend: 'pdf', title: 'Status Report', className: 'btn-sm'},
