...
$maindata = null;
if($_POST){
	$maindata = $Reports->ParkingReport($_POST,$fgmembersite->connection,$fgmembersite);
...
<head>
    ...
    <!-- Page title -->
    <title><?= $fgmembersite->Title1 ?> | Parking Report <?php if($_POST){ echo $_POST['select'];} ?></title>
       ...
       <select class="select form-control" id="select" name="select">
			...
			<?= $fgmembersite->VehicleListOptions(); ?>
				...
				<div class="form-group" id="data_1"  style="width: 500px;">
					...
					<div class="input-group date col-sm-10"  style="padding-right:15px; padding-left:15px">
						<span class="input-group-addon"><i class="fa fa-calendar"></i></span><input name="end_date" type="text" class="form-control" id="trackdateend" autocomplete="off">
					</div>
				</div>
     <div class="form-group">
					...
					<div class="hpanel">
						...
						<div class="panel-body">
							<table id="optdetails" class="table table-striped table-bordered table-hover" width="100%">
								<thead>
								<?php echo "<tr><th  colspan='6' style='text-align: center;'>".$_POST['select']." Parking Report From".$fgmembersite->UserDateFormat($_POST['st_date'])." To ".$fgmembersite->UserDateFormat($_POST['end_date'])."</th></tr>"; ?>
								<tr>
									<th>Time</th>
									<th>Speed</th>
									<th>Status</th>
    ...
    $(function () {
        ...
        $('#optdetails').dataTable( {
            ...
            buttons: [
                ...
                {extend: 'csv',title: 'Parking Report <?php if($_POST){ echo $_POST['select'];} ?>', className: 'btn-sm'},
                {extend: 'pdf', title: 'Parking Report <?php if($_POST){ echo $_POST['select'];} ?>', className: 'btn-sm'},
