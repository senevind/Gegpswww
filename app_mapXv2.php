...
function markers_set_position(updatedresult,sysno){
		...
		document.getElementById('subvelosity'+sysno).innerHTML = parseInt(updatedresult.lastvelosity*0.621371);
...
<!-- Main Wrapper -->
	...
	<div id="mapholder" class="p-m tab-pane active" style="height: calc(100vh + 10px); padding:0px">
	</div>
	</div>
