...
<head>
    ...
    <!-- Page title -->
    <title>G supertrack | Task Report <?php if($_POST){ echo $_POST['select'];} ?></title>
            ...
            <div class="hpanel">
                ...
                <div class="panel-body">
                    <table id="optdetails" class="table table-striped table-bordered table-hover" width="100%">
													<thead>
													<?php echo "<tr><th  colspan='8' style='text-align: center;'>".$_POST['select']." Task Report From ".$_POST['st_date']." To ".$_POST['end_date']."</th></tr>"; ?>
													<tr>
														<th>Task Name</th>
														<th>Route ID</th>
														<th>Tracker ID</th>
													...
													<tbody>
														...
														{
															echo $Reports->TaskReport($fgmembersite->connection,$_POST['select'],$_POST['st_date'],$_POST['end_date']); 
														}
														?>
													</tbody>
													<tfoot>
    ...
    $(function () {
        $('#optdetails').dataTable( {
            ...
            buttons: [
                ...
                {extend: 'csv',title: 'Task Report <?php if($_POST){ echo $_POST['select'];} ?>', className: 'btn-sm'},
                {extend: 'pdf', title: 'Task Report <?php if($_POST){ echo $_POST['select'];} ?>', className: 'btn-sm'},
