...
$maindata = null;
if($_POST){
	$maindata = $Reports->WebTripReport($_POST['Vehicle'],$_POST['st_date'],$_POST['st_date'],$fgmembersite);
...
<head>
    ...
    <!-- Page title -->
    <title><?= $fgmembersite->Title1 ?> | Trip Report <?php if($_POST){ echo $_POST['select'];} ?></title>
   ...
   <div class="col-md-6 col-sm-6 col-xs-12">
    <form class="form-horizontal" method="post">
     <div class="form-group"  style="width: 500px;">
      <label class="control-label col-sm-2" for="Vehicle">
       Select a Vehicle
      </label>
      <div class="col-sm-10">
		<select class="select2_demo_2 form-control" id="Vehicle" name="Vehicle">
	...
	<div class="form-group" id="data_1"  style="width: 500px;">
		...
		<div class="input-group date col-sm-10"  style="padding-right:15px; padding-left:15px">
			<span class="input-group-addon"><i class="fa fa-calendar"></i></span><input name="st_date" type="text" class="form-control" id="trackdatest" autocomplete="off">
		</div>
	</div>
     <div class="form-group">
					...
					<div class="hpanel">
						...
						<div class="panel-body">
							<table id="optdetailsEmpty" class="table table-striped table-bordered table-hover" width="100%">
								<thead>
								<?php echo "<tr><th  colspan='6' style='text-align: center;'>".$_POST['Vehicle']." Trip Report ".$_POST['st_date']."</th></tr>"; ?>
								<tr>
									<th>Start Time</th>
									<th>Start Address</th>
									<th>End Time</th>
					...
					<div class="hpanel">
						...
						<div class="panel-body">
							<table id="optdetails" class="table table-striped table-bordered table-hover" width="100%">
								<thead>
								<?php echo "<tr><th  colspan='6' style='text-align: center;'>".$_POST['Vehicle']." Trip Report ".$fgmembersite->UserDateFormat($_POST['st_date'])."</th></tr>"; ?>
								<tr>
									<th>Start Time</th>
									<th>Start Address</th>
									<th>End Time</th>
    ...
    $(function () {
        ...
        $('#optdetails').dataTable( {
            ...
            buttons: [
                ...
                {extend: 'csv',title: 'Trip Report <?php if($_POST){ echo $_POST['select'];} ?>', className: 'btn-sm'},
                {extend: 'pdf', title: 'Trip Report <?php if($_POST){ echo $_POST['select'];} ?>', className: 'btn-sm'},
