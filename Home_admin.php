...
<head>
	...
	<script> var Vehicleinfo =  <?php
		$objectlist = $fgmembersite->getbuslisttablearraySTD_Admin();
...
markers[sysno] = L.Marker.movingMarker([[lat,lng]],[1000],{id:sysno}).addTo(VeMarkers).bindTooltip("<b>"+detail+"</b>",{permanent: true,direction: 'right',offset:L.point(25, -25)}).bindPopup(setinfocontent(sysno,Vehicleinfo.Vehicleinfo),{offset: [0, -50]}).on('click', function(e) 
{
	console.log(e.latlng);
	console.log(this.options.id);
...
<div id="wrapper">
    ...
    <div id="right-sidebar" class="animated fadeInRight" style="z-index: 5200;width: 360px!important;">
        ...
        <div class="p-m">
			...
			<label> <input type="checkbox" class="i-checks" id="showhidelabel" checked> Label show/hide </label>
