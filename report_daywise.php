...
$maindata = null;
if($_POST){
	$maindata = $Reports->DaywiceReport($fgmembersite,$_POST['st_date'],$fgmembersite->connection,$_POST['select']);
}
...
<head>
    ...
    <!-- Page title -->
    <title><?= $fgmembersite->Title1 ?> | Day Wise Report</title>
					...
					<div class="hpanel">
						...
						<div class="panel-body">
							<table id="optdetailsEmpty" class="table table-striped table-bordered table-hover" width="100%">
								<thead>
								<?php echo "<tr><th  colspan='6' style='text-align: center;'>".$_POST['select']." Summery Report </th></tr>"; ?>
