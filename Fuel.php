...
<aside id="menu">
    <div id="navigation">
        ...
        <ul class="nav" id="side-menu">
			...
			<li class="active">
					<a href="ReportTrip.php"><i class="fa fa-file-text-o" style="color:#64CC34"></i> <span class="nav-label">Report View</span></a>		
            </li>
			<li class="active">
					<a href="trackingpics.php"><i class="fa fa-picture-o" style="color:#64CC34"></i> <span class="nav-label">Picture View</span></a>		
            </li>
			<li class="active">
					<a href="trackingpics.php"><i class="fa fa-picture-o" style="color:#64CC34"></i> <span class="nav-label">Tracking Analysis</span></a>		
            </li>
        </ul>
    </div>
</aside>
    ...
    <div class="col-lg-12">
        <div class="hpanel">
            <div class="panel-heading">
                ...
                Vehicle Cumiative Distance Analysis
            </div>
