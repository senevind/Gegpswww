...
$maindata = null;
if($_POST){
	$maindata = $Reports->odReport($_POST,$fgmembersite->connection,$fgmembersite->UserName());
}
...
<head>
    ...
    <!-- Page title -->
    <title><?= $fgmembersite->Title1 ?> | O/D Report <?php if($_POST)
	{
		echo $_POST['select'];
	}
	?></title>
                ...
                <div class="panel-body">
														<?php
															if($_POST)
															{
																...
																<thead><tr><th  colspan='5'>".$_POST['select']."</th></tr>
																<tr><th>Start</th><th>Time</th><th>Stop</th><th>Time</th><th>Duration</th></tr></thead><tbody>".$maindata."</tbody></table></div></div></div>";
															}
														?>
                </div>
            </div>
    ...
    $(function () {
        ...
        $('#optdetails').dataTable( {
            ...
            buttons: [
                ...
                {extend: 'csv',title: 'Monthly O/D Report <?php if($_POST){ echo $_POST['select'];} ?>', className: 'btn-sm'},
                {extend: 'pdf', title: 'Monthly O/D Report <?php if($_POST){ echo $_POST['select'];} ?>', className: 'btn-sm'},
